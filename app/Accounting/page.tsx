...
export default function JoinPage() {
  ...
  const jobObj = JobsObj["Accounting"];
  return (
    <div>
      ...
      <PageWrap>
        <PrimaryTitle
          className="block md:hidden md:pt-[150px] text-[#fff]"
          align="text-left"
          title={
            <>
              Join Our Talent{" "}
        ...
        <div className="lg:flex items-start">
          <div className="flex-1 md:pr-[74px]">
            ...
            <div className="mb-[39px] md:mb-[50px]">
              <JoinDecTitle title="Job Responsibilities" />
              <JoinDecCnt
                align="text-left"
                title={
                  <span
            ...
            <div className="mb-[39px] md:mb-[50px]">
              <JoinDecTitle title="Qualifications" />
              <JoinDecCnt
                align="text-left"
                title={
                  <span
          ...
          <div className="lg:w-[416px] lg:max-w-[416px]">
            ...
            >
              <div className="font-semibold text-[#000000] text-[12px] leading-[20px] md:text-[22px] md:leading-[50px]">
                Other positions
              </div>
              <svg
